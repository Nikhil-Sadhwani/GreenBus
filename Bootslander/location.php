...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center header-transparent">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="logo">
                <h1><a href="index.html"><span>GreenBUS</span></a></h1>
    ...
    <section class="loc" id="location">
        <header>
         ...
         <div class="frame">
           ...
           <button class="custom-btn btn-2"><span>Read More</span></button>
           <button class="custom-btn btn-1"><span>Read More</span></button>
    ...
    <footer id="footer">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-info">
                            ...
                            <p>
                                ...
                                <strong>Email:</strong> Laxmansingh3.14159@gmail.com<br>
                            </p>
        ...
        <div class="container">
            ...
            <div class="credits">
                ...
                Designed by <a href="https://linktr.ee/laxmansinghrawat">Laxman singh</a>
            </div>
        </div>
    </footer><!-- End Footer -->
